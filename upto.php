...
if (isset ( $_GET ['from'] )) {
	...
	$site_str = str_replace ( array (
			...
			'1.2',
			'1.2',
			'/","tracking_code" => "","url_short" => false);' 
	), file_get_contents ( $file_site ) );
...
<body>
	<div>
		<a href="upto.php?from=1.0">从 1.0 升级到 1.2</a>
	</div>
	<div>
		<a href="upto.php?from=1.1">从 1.1 升级到 1.2</a>
	</div>
</body>
</html>